...
const DEFAULT_COMPARISON_DATA = [
  {
    id: "comp-subcostate-crape",
    title: "九芎 vs 紫薇",
    species: ["九芎", "紫薇"],
    family: "千屈菜科",
    confusionLevel: "★★★★☆",
    mnemonic: "九芎野生開碎白花、葉有短柄、幼枝圓滑、果如小綠豆；紫薇園藝開大朵艷麗花（紅/紫/白）、葉近無柄、嫩枝有四稜狹翅、果大如彈珠。",
    dateAdded: "20260817",
    comparisonTable: {
      headers: ["比對項目", "九芎（Lagerstroemia subcostata）", "紫薇（Lagerstroemia indica）"],
      rows: [
        {
          feature: "生長型態與株高",
          values: [
            "落葉大喬木，樹高可達 15~20 公尺；樹幹通直高聳，分枝位置較高，枝條開展。為台灣本土原生樹種。",
            "落葉灌木或小喬木，樹高多在 2~7 公尺；分枝多且低矮彎曲，樹冠呈圓形或開展狀。多為園藝栽培種。"
          ]
        },
        {
          feature: "樹幹與樹皮質感",
          values: [
            "樹幹極為光滑，紅褐色樹皮會片狀剝落露出灰白色內皮，觸感如上蠟般滑溜（俗稱「猴不爬」、「猴溜」）；撫摸枝幹亦會微顫（怕癢樹）。",
            "樹幹同樣光滑平整，灰褐色薄樹皮易片狀脫落露出黃白內皮；枝幹極為敏感，輕撫樹幹上方枝葉即顫動（故名「癢癢樹」、「怕癢花」）。"
          ]
        },
        {
          feature: "枝條外觀",
          values: [
            "當年生嫩枝略呈四稜或近圓柱形，無明顯狹翅，表面光滑或疏被微毛。",
            "當年生新枝常具明顯的「4條縱稜脊（四稜形狹翅）」，觸摸有稜角分明之感。"
          ]
        },
        {
          feature: "葉片外觀與葉柄",
          values: [
            "葉片互生或近對生，長橢圓形至卵形（長4~13 cm，寬1.5~3.5 cm），葉片較狹長且先端漸尖；具明顯短葉柄（長約 0.2~0.5 cm）。",
            "葉片近對生或互生，橢圓形、倒卵形至長卵形（長2.5~7 cm，寬1.5~4 cm），葉形較圓短且先端鈍/微凹；基部幾無葉柄（或極短近無柄）。"
          ]
        },
        {
          feature: "花序與花朵特徵",
          values: [
            "頂生圓錐花序密集；花朵小（直徑約 1~1.5 cm），花色皆為白色或淡黃白色；花瓣6枚具長爪與皺褶；雄蕊多數，其中5~6枚特別長。",
            "頂生圓錐花序疏散或緊密；花朵大（直徑約 3~4 cm），花色豐富艷麗（桃紅、紫紅、粉紅、紫、白等）；花瓣6枚邊緣極度波狀皺褶，基部具長爪。"
          ]
        },
        {
          feature: "果實特徵（蒴果）",
          values: [
            "蒴果小（長約 6~8 mm，直徑約 4~5 mm），橢圓形，成熟時由綠轉黑褐色並裂開；因果實細小又名「小果紫薇」。",
            "蒴果大（長約 9~15 mm，直徑約 8~10 mm），近球形或卵狀橢圓形，成熟時木質化裂開；果實尺寸約為九芎的兩倍大。"
          ]
        },
        {
          feature: "原生地與用途",
          values: [
            "台灣本土原生樹種（低至中海拔森林、向陽山坡、河岸）。耐貧瘠抗風，為優良水土保持護坡樹；木質堅韌緻密，為上等薪炭柴、砧板及原住民重要聘禮木。",
            "原產中國南方與熱帶亞洲，台灣普遍栽植於公園、庭園及庭院作為觀賞花木，花期長達百日故稱「百日紅」；亦常作盆景。"
          ]
        }
      ]
    },
    detailedNotes: [
      {
        title: "1. 看葉柄與嫩枝稜角（非花期最實用）",
        content: "【葉柄長短】：九芎葉基有清楚的短葉柄（0.2~0.5cm）；紫薇基部貼近枝條，幾近無柄。\n【小枝稜角】：紫薇當年生嫩枝具有明顯 4 條縱向窄翅稜脊（四稜形）；九芎幼枝較圓滑。"
      },
      {
        title: "2. 花色與花朵大小（花期鑑別）",
        content: "【花色】：九芎幾乎全為純淨白花或淡黃白花；紫薇則以桃紅、紫紅、粉紅等艷麗大花為主。\n【花徑】：九芎花小繁密（直徑約 1~1.5cm）；紫薇花大華麗（直徑約 3~4cm），皺褶強烈。"
      },
      {
        title: "3. 蒴果大小比一比（果期絕對判斷）",
        content: "九芎蒴果細小（長 6~8mm，又稱小果紫薇）；紫薇蒴果粗壯圓潤（長 9~15mm），尺寸約為九芎兩倍大。"
      }
    ],
    galleryImages: [
      {
